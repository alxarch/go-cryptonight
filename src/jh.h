...
typedef unsigned char jhBitSequence;
typedef unsigned long long jhDataLength;
typedef enum {SUCCESS = 0, FAIL = 1, BAD_HASHLEN = 2} jhHashReturn;

jhHashReturn jh_hash(int hashbitlen, const jhBitSequence *data, jhDataLength databitlen, jhBitSequence *hashval);
